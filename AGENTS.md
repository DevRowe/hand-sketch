...
| `npm run solar:site` | rebuild the public GitHub Pages site (`docs/index.html`, `docs/solar/media/`: HD and web mp4s plus posters) from an existing `npm run solar` render and its frames |
